...
__all__ = ["Linear","Module","L1loss", "MSELoss", "CrossEntropyLoss", "HuberLoss", "SmoothL1Loss", "SoftMarginLoss","calculate_gain","uniform_","normal_","constant_","ones_","zeros_","eye_"]